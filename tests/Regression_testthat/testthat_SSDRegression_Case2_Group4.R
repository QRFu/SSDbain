...
Hyp1<-'beta1=beta2=beta3=beta4=0'
Hyp2<-'beta1>0&beta2>0&beta3>0&beta4>0'
ratio<-c(1,1,1,1)
R_square1=0
R_square2=0.13
BFthresh=3
...
bf<-unlist(BF)
bfju_H0<-bf
bf0j_H0<-na.omit(bf0u_H0/bfju_H0)
T0<-length(bf0j_H0)
...
test_that("SSDbain", {expect_equal(eta1_test_J2,eta1_J2,tolerance = .01)})
test_that("SSDbain", {expect_equal(eta2_test_J2,eta2_J2,tolerance = .01)})

test_that("SSDbain", {expect_equal(eta1_test_J3,eta1_J3 ,tolerance = .01)})
test_that("SSDbain", {expect_equal(eta2_test_J3,eta2_J3,tolerance = .01)})
