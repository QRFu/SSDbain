...
#========================================================================================
#  using SSDbain to test the BF02 for the one-sided t-test if H0 is true
#========================================================================================

Res<-SSDttest(type='equal',Population_mean=c(0.5,0),var=NULL,BFthresh=3,eta=0.8,Hypothesis='one-sided',T=1000)
N_J1<-Res[[1]][[5]]
eta1_J1<-Res[[1]][[3]]
eta2_J1<-Res[[1]][[4]]
...
J<-1
#========================================================================================")
#  using SSDbain to test the BF20 for the one-sided t-test if H0 is true
#========================================================================================")
m1<-0
m2<-0
sd1<-sd2<-1
...
#========================================================================================")
#  using SSDbain to test the BF20 for the one-sided t-test if H2 is true
#========================================================================================")
m1<-0.5
m2<-0
